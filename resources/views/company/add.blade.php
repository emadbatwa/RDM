                                ...
                                <div class="card-header card-header-primary">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <button onclick="location.href='{{ url('user/employees') }}'" class="btn btn-sm btn-primary">{{ __('العودة للقائمة') }}</button>
                                        </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                        <label class="col-sm-2 col-form-label">{{ __('البريد الالكتروني') }}</label>
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('البريد الاكتروني') }}" value="{{ old('email') }}" required />
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="row">
                                        <label class="col-sm-2 col-form-label" for="input-password">{{ __('كلمة المرور') }}</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="card-footer ml-auto mr-auto">
                                        <button type="submit" class="btn btn-primary">{{ __('اضافة موظف') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
